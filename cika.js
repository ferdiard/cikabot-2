...
const { help, bahasa, donasi, limitend, limitcount } = require('./cika/help')
...
prefix = "!"
name = "NA Bot"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN NABOT😁"
rmenu = "HAI TEMEN NABOT👋 JANGAN LUPA DONASI YAA:)"
limitt = 10
ban = []
...
async function starts() {
	...
	fs.existsSync('./cika.json') && client.loadAuthInfo('./cika.json')
	...
	await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./cika.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const FerdiGans = ["6282169369877@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["6282169369877@s.whatsapp.net"] // owner number ubah aja
		...
		case 'daftar':
         ...
         case 'lirik':
                ...
                if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('62895603272884@s.whatsapp.net', options, text, {quoted: mek})
